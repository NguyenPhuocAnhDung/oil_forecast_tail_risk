...
def generate_white_regular_fig1():
    # Canvas dimensions: 18.5 x 7.6 inches
    ...
    # --------------------------------------------------------------------------
    # MASTER HEADER BANNER (White Box, Black Border, Black Regular Text)
    # --------------------------------------------------------------------------
    ...
    ax.text(9.25, 7.14, 'NEURAL NETWORK ARCHITECTURE OF GUMNetHet', 
            ha='center', va='center', fontsize=13.5, fontweight='normal', color='#000000')

    # ==========================================================================
    # MAIN ARCHITECTURE CONTAINER (White Box, Black Border)
    # ==========================================================================
    ...
    ax.add_patch(in_box)
    ax.text(1.70, 6.18, 'Input Sequence Tensor', ha='center', va='center', fontsize=11.5, fontweight='normal', color='#000000')
    ax.text(1.70, 5.82, r'$X \in \mathbb{R}^{B \times L \times D}$ ($L=30$)', ha='center', va='center', fontsize=11.0, fontweight='normal', color='#000000')

    # Sub-partition cards (White, black border, black regular text)
    ...
    ax.add_patch(p1)
    ax.text(1.70, 5.25, 'Spot Price Features', ha='center', va='center', fontsize=10.5, fontweight='normal', color='#000000')
    ax.text(1.70, 4.85, r'$x^{\mathrm{CNN}} \in \mathbb{R}^{B \times L \times D_1}$', ha='center', va='center', fontsize=10.0, fontweight='normal', color='#000000')
    ax.text(1.70, 4.38, '• MG95, MG92, MG97\n• DO 0.001%, DO 0.05%\n• WTI, Brent, Naphtha', ha='center', va='center', fontsize=9.0, fontweight='normal', color='#000000', linespacing=1.2)

    p2 = patches.FancyBboxPatch((0.55, 2.30), 2.30, 1.60, boxstyle='round,pad=0.02,rounding_size=0.02',
                                facecolor='#FFFFFF', edgecolor='#000000', linewidth=0.9)
    ax.add_patch(p2)
    ax.text(1.70, 3.58, 'Macro & GPR Risk', ha='center', va='center', fontsize=10.5, fontweight='normal', color='#000000')
    ax.text(1.70, 3.18, r'$x^{\mathrm{GRU}} \in \mathbb{R}^{B \times L \times D_2}$', ha='center', va='center', fontsize=10.0, fontweight='normal', color='#000000')
    ax.text(1.70, 2.70, '• Geopolitical Risk (GPR)\n• USD Index (DXY)\n• GPR_MA30, DXY_MA30', ha='center', va='center', fontsize=9.0, fontweight='normal', color='#000000', linespacing=1.2)

    p3 = patches.FancyBboxPatch((0.55, 0.60), 2.30, 1.55, boxstyle='round,pad=0.02,rounding_size=0.02',
                                facecolor='#FFFFFF', edgecolor='#000000', linewidth=0.9)
    ax.add_patch(p3)
    ax.text(1.70, 1.85, 'Ratios & Volatility', ha='center', va='center', fontsize=10.5, fontweight='normal', color='#000000')
    ax.text(1.70, 1.45, r'$x^{\mathrm{KAN}} \in \mathbb{R}^{B \times L \times D_3}$', ha='center', va='center', fontsize=10.0, fontweight='normal', color='#000000')
    ax.text(1.70, 0.98, '• Crack Spread Ratios\n• Realized Vol (10d, 30d)\n• Day_sin, Day_cos', ha='center', va='center', fontsize=9.0, fontweight='normal', color='#000000', linespacing=1.2)

    # --- 2. Three Specialized Experts (White, Black Border, Regular Text) ---
    # Expert 1: CNN
    exp1_box = patches.FancyBboxPatch((3.45, 4.55), 3.50, 1.95, boxstyle='round,pad=0.02,rounding_size=0.03',
                                     facecolor='#FFFFFF', edgecolor='#000000', linewidth=1.0)
    ax.add_patch(exp1_box)
    ax.text(5.20, 6.15, 'Expert 1: Multi-Scale 1D-CNN', ha='center', va='center', fontsize=11.5, fontweight='normal', color='#000000')
    exp1_text = (
    ...
    ax.text(5.20, 5.25, exp1_text, ha='center', va='center', fontsize=10.0, fontweight='normal', color='#000000', linespacing=1.3)

    # Expert 2: GRU
    exp2_box = patches.FancyBboxPatch((3.45, 2.50), 3.50, 1.85, boxstyle='round,pad=0.02,rounding_size=0.03',
                                     facecolor='#FFFFFF', edgecolor='#000000', linewidth=1.0)
    ax.add_patch(exp2_box)
    ax.text(5.20, 4.00, 'Expert 2: Stacked GRU-Attention', ha='center', va='center', fontsize=11.5, fontweight='normal', color='#000000')
    exp2_text = (
    ...
    ax.text(5.20, 3.10, exp2_text, ha='center', va='center', fontsize=10.0, fontweight='normal', color='#000000', linespacing=1.3)
    ...
    ax.text(5.20, 1.95, 'Expert 3: Wavelet-KAN Shock Block', ha='center', va='center', fontsize=11.5, fontweight='normal', color='#000000')
    exp3_text = (
    ...
    ax.text(5.20, 1.20, exp3_text, ha='center', va='center', fontsize=10.0, fontweight='normal', color='#000000', linespacing=1.3)

    # --- 3. Horizon-Aware Dynamic Gating Router (White, Black Border, Regular Text) ---
    ...
    ax.text(9.77, 6.18, 'Step 2: Horizon-Aware Dynamic Router', ha='center', va='center',
            fontsize=11.5, fontweight='normal', color='#000000')

    # Concat Box
    cat_box = patches.FancyBboxPatch((7.55, 0.65), 1.55, 5.10, boxstyle='round,pad=0.02,rounding_size=0.02',
                                     facecolor='#FFFFFF', edgecolor='#000000', linewidth=0.9)
    ax.add_patch(cat_box)
    ax.text(8.32, 5.35, 'Feature Concat', ha='center', va='center', fontsize=10.5, fontweight='normal', color='#000000')
    cat_content = (
    ...
    ax.text(8.32, 2.95, cat_content, ha='center', va='center', fontsize=10.0, fontweight='normal', color='#000000')

    # MLP Gate Box
    mlp_gate = patches.FancyBboxPatch((9.30, 2.10), 1.25, 2.70, boxstyle='round,pad=0.02,rounding_size=0.02',
                                      facecolor='#FFFFFF', edgecolor='#000000', linewidth=0.9)
    ax.add_patch(mlp_gate)
    ax.text(9.92, 4.40, 'MLP Gate', ha='center', va='center', fontsize=10.5, fontweight='normal', color='#000000')
    ax.text(9.92, 3.20, '(128 units)\n+\nGELU\n+\nSoftmax\nLayer', ha='center', va='center', fontsize=9.5, fontweight='normal', color='#000000', linespacing=1.25)

    # Weights & Fusion Box
    fuse_box = patches.FancyBboxPatch((10.75, 0.65), 1.25, 5.10, boxstyle='round,pad=0.02,rounding_size=0.02',
                                      facecolor='#FFFFFF', edgecolor='#000000', linewidth=0.9)
    ax.add_patch(fuse_box)
    ax.text(11.37, 5.35, 'Router Weights', ha='center', va='center', fontsize=10.5, fontweight='normal', color='#000000')
    fuse_content = (
        r'$w_1$ (CNN)' + '\n' +
        r'$w_2$ (GRU)' + '\n' +
        r'$w_3$ (KAN)' + '\n\n' +
    ...
    ax.text(11.37, 2.90, fuse_content, ha='center', va='center', fontsize=9.5, fontweight='normal', color='#000000', linespacing=1.25)

    # --- 4. Horizon Heads & Quantile Heads (White, Black Border, Regular Text) ---
    ...
    h1 = patches.FancyBboxPatch((12.70, 4.30), 2.50, 1.45, boxstyle='round,pad=0.01,rounding_size=0.02',
                                facecolor='#FFFFFF', edgecolor='#000000', linewidth=0.9)
    ax.add_patch(h1)
    ax.text(13.95, 5.40, 'Short Head: $h \\in \\{1, 3\\}$', ha='center', va='center', fontsize=10.5, fontweight='normal', color='#000000')
    ax.text(13.95, 4.80, '• Direct Linear Projection\n• Preserves Short Momentum\n• Fast O(1) Latency Execution', 
            ha='center', va='center', fontsize=9.0, fontweight='normal', color='#000000', linespacing=1.2)

    h2 = patches.FancyBboxPatch((12.70, 2.45), 2.50, 1.60, boxstyle='round,pad=0.01,rounding_size=0.02',
                                facecolor='#FFFFFF', edgecolor='#000000', linewidth=0.9)
    ax.add_patch(h2)
    ax.text(13.95, 3.68, 'Medium Head: $h \\in \\{5, 7, 10\\}$', ha='center', va='center', fontsize=10.5, fontweight='normal', color='#000000')
    ...
    h3 = patches.FancyBboxPatch((12.70, 0.65), 2.50, 1.55, boxstyle='round,pad=0.01,rounding_size=0.02',
                                facecolor='#FFFFFF', edgecolor='#000000', linewidth=0.9)
    ax.add_patch(h3)
    ax.text(13.95, 1.85, 'Long Head: $h \\in \\{20, 60\\}$', ha='center', va='center', fontsize=10.5, fontweight='normal', color='#000000')
    ...
    ax.text(16.65, 5.35, 'Calibrated Tail Risk', ha='center', va='center', fontsize=10.5, fontweight='normal', color='#000000')
    res_content = (
    ...
    ax.text(16.65, 2.95, res_content, ha='center', va='center', fontsize=9.2, fontweight='normal', color='#000000', linespacing=1.25)

    # Connecting Arrows (Clean, thin black arrows)
    arr = dict(facecolor='#000000', edgecolor='#000000', width=1.2, headwidth=5.5, headlength=5.5)
    ...
    plt.tight_layout()
    output_path = 'paper_figures/fig1_gumnethet_white_regular.png'
    fig.savefig(output_path, dpi=300, bbox_inches='tight', facecolor='#FFFFFF')
    plt.close(fig)
    print(f"Successfully generated pure white, black text, regular font Figure 1: {output_path}")

generate_white_regular_fig1()
