...
def build_perfect_ieee_document(is_en=True, out_path="GUMNETHet_FAIRv4_final.docx"):
    print(f"Building perfect IEEE document ({'EN' if is_en else 'VI'}) -> {out_path}...")
    ...
    # Remove all existing paragraphs and tables from template body
    ...
    # Base sectPr for Section 1 (Top header: 1 column)
    base_sectPr = parse_xml(
        f'<w:sectPr {nsdecls("w")}>'
        f'<w:pgSz w:w="11906" w:h="16838"/>' # A4 (8.27 in x 11.69 in)
    ...
    # =========================================================================
    # PART 1: TITLE (1 COLUMN ACROSS TOP)
    # =========================================================================
    p_title = add_p(style_name='paper title', align=WD_ALIGN_PARAGRAPH.CENTER, space_before=12, space_after=14, line_spacing=1.15)
    ...
    # =========================================================================
    # PART 2: AUTHORS (3 COLUMNS PERFECTLY HORIZONTALLY ALIGNED ON TOP)
    # Using 1-row 3-column table with top vertical alignment
    # =========================================================================
    tbl_auth = doc.add_table(rows=1, cols=3)
    tbl_auth.alignment = WD_TABLE_ALIGNMENT.CENTER
    tbl_auth.autofit = False

    # Remove all borders & zero padding
    ...
    col_w = Inches(2.42) # 2.42 * 3 = 7.26 inches (matches printable A4 area)
    authors_data = [
        {
            "num": "1", "sup": "st",
    ...
    p_trans = add_p(style_name='Normal', align=WD_ALIGN_PARAGRAPH.CENTER, space_before=0, space_after=10)
    ...
    # =========================================================================
    # PART 3: 2-COLUMN CONTINUOUS BODY SECTION
    # =========================================================================
...
if __name__ == '__main__':
    build_perfect_ieee_document(is_en=True, out_path="GUMNETHet_FAIRv4_final.docx")
    build_perfect_ieee_document(is_en=False, out_path="GUMNETHet_FAIRv4_final_VI.docx")
