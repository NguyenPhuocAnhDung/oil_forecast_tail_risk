...
def generate_h3_report():
    ...
    out_lines.append('')
    out_lines.append('| STT | Mô Hình (Model) | Phân Nhóm | XĂNG: MAE (Mean ± Std) | XĂNG: RMSE (Mean ± Std) | XĂNG: MAPE (%) | XĂNG: CRPS | XĂNG: DA (%) | DẦU: MAE (Mean ± Std) | DẦU: RMSE | DẦU: MAPE (%) | DẦU: CRPS |')
    out_lines.append('| :---: | :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |')
